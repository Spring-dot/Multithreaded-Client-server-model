...
# we have added lock to avoid data racing
...
@app.route("/")
def home():
    return "Hello!, Provide the action to be performed: [clean_array, get_array, add_value]!"
...
def add_value():
    ...
    # Release lock to give another client
